...
export default function Main () {
	...
	return (
		<div className="h-screen">
			...
			<div className="flex space-x-3 mb-4 text-sm font-medium m-8">
                <div className="flex-auto flex space-x-3">
                    <button onClick={handleClickScratch} className="w-1/2 flex items-center justify-center rounded-md bg-black text-white p-2" type="submit">Train from scratch</button>
                    <button onClick={handleClickRetrain} className="w-1/2 flex items-center justify-center rounded-md border bg-gray-300 border-gray-300 p-2" type="button">Train with newest data</button>
                </div>
            </div>
            <div className="flex space-x-3 mb-4 text-sm font-medium m-8 h-1/3">
                ...
                <div className="flex-auto flex w-1/2">
                    <button onClick={handleClickPrediction} className="w-1/2 flex items-center justify-center rounded-md bg-black text-white" type="submit">Get Prediction</button>
                    <p className="w-1/2 flex items-center justify-center rounded-md bg-black text-white p-2 ml-3">{prediction}</p>
                </div>
            </div>
            <div className="flex space-x-3 mb-4 text-sm font-medium m-8 h-1/3">
                ...
                <div className="flex-auto flex w-1/4">
                    <button onClick={handleClickNewData} className="w-full flex items-center justify-center rounded-md bg-black text-white" type="submit">Add data</button>
                </div>
            </div>
		</div>
	)
